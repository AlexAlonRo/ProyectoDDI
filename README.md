...
|3|Sensor de pulso|Podría medir la frecuencia cardíaca de la persona que usa la gorra. Esto podría proporcionar información sobre su nivel de estrés o emoción, y ajustar la configuración de la gorra en consecuencia. Por ejemplo, aumentar la vibración de la gorra si se detecta una frecuencia cardíaca alta, indicando posibles situaciones de emergencia.|<https://pigra.com.mx/113-large_default/sensor-pulso-cardiaco.jpg" width="500px"/>|$60.00|1|
|4|HC-SR04|Puede detectar la presencia de objetos cercanos. Esto podría ser útil para alertar a la persona sorda sobre la presencia de obstáculos o personas cercanas, evitando posibles colisiones.|<img src= "https://m.media-amazon.com/images/I/61hEppQDiXL._AC_SX466_.jpg" width="500px"/>|$50.00|1|
